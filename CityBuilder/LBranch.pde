public class LBranch {
  ...
  public LBranch( LModule m1, LModule m2, float sx, float sy, float sa ) {
    ...
    switch(road_type) {
      case(0):
      fc=color(0.0, 0.6, 0.2);
      bc=color(0.0, 0.3, 0.1); 
      break;
      case(1):
      fc=color(1.0, 0.3, 0.3);
      bc=color(0.8, 0.1, 0.1); 
      break;
      case(2):
      fc=color(1.0, 0.8, 0.4);
      bc=color(0.8, 0.6, 0.2); 
      break;
      case(3):
      fc=color(1.0, 1.0, 1.0);
      bc=color(0.8, 0.8, 0.8); 
      break;
    }
    //}
  ...
  void drawMap(boolean outlines) {
    ...
    ArrayList<LTerminal> terminals = new ArrayList<LTerminal>();
    ...
    if ( terminals.size() == 2 || terminals.size()==3 ) {
      beginShape(LINES);
